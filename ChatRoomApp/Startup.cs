...
using static ChatRoomApp.Infrastructure.Bot.BotCommunicationService;
...
namespace ChatRoomApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDefaultIdentity<ChatRoomUser>(options => options.SignIn.RequireConfirmedAccount = false)
